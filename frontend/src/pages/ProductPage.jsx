  ...
  return (
    <>
      <SimpleGrid className="topgrid">
        <Box className="gridbox" bg="#b18341" height="80px">
          DRESSES
        </Box>
        <Box className="gridbox" bg="#9a5462" height="80px">
          PANTS
        </Box>
        <Box className="gridbox" bg="#b48779" height="80px">
          JEANS
        </Box>
        <Box className="gridbox" bg="#cc835a" height="80px">
          GETAWAY & RESORT <br />
          WEAR
        </Box>
        <Box className="gridbox" bg="#887277" height="80px">
          TOPS
        </Box>
        <Box className="gridbox" bg="#a57772" height="80px">
          INTIMATES
        </Box>
      </SimpleGrid>
      <Box className="maincontainer">
        ...
        <Box className="productscontainer">
          <Flex className="productscontainertop">
            <Box className="label">
              <Heading size={"md"}>Dresses</Heading>
            </Box>
