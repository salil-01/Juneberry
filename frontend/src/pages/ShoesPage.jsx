import { Box, Button, Flex, Heading, SimpleGrid, Skeleton, Stack, Text } from "@chakra-ui/react";
  ...
  return (
    <>
      <SimpleGrid className="topgrid">
        <Box className="gridbox" bg="#13674c" height="80px">
          5-5.5
        </Box>
        <Box className="gridbox" bg="#429786" height="80px">
          6-6.5
        </Box>
        <Box className="gridbox" bg="#58839c" height="80px">
          7-7.5
        </Box>
        <Box className="gridbox" bg="#4b9587" height="80px">
          8-8.5
        </Box>
        <Box className="gridbox" bg="#588a52" height="80px">
          9-9.5
        </Box>
        <Box className="gridbox" bg="#6799aa" height="80px">
          10-11
        </Box>
      </SimpleGrid>
        ...
        <Box className="productscontainer">
          <Flex className="productscontainertop">
            ...
            <Flex className="sortcontainer">
              <select onChange={handlesort} style={{ padding: "5px" }}>
          ...
          <Box className="productscontainer2">
            {isLoading
              ...
              : products?.map((el) => {
                  return (
                    <Link key={el._id} to={`/${"shoes"}/${el._id}`}>
                      <Box
                        style={{
                          color: "gray",
                          textAlign: "left",
